      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 shadow-lg text-center">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 dark:border-gray-600 hover:border-orange-400 bg-white dark:bg-gray-700 text-gray-800 dark:text-white font-semibold py-3 rounded-xl transition-all hover:shadow-md"
          >
          ...
          <p className="mt-6 text-xs text-gray-400 dark:text-gray-500">
            Google sign-in is optional. You can place orders without an account.
          </p>
        </div>
      </div>
    </div>
